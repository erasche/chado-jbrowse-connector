...
func OrgTrackListJson(w http.ResponseWriter, r *http.Request) {
	...
	tracks = append(tracks, SeqTrack{
		...
		BaseURL: "http://localhost:5000/link/yeast/",
		Query: queryMap,
	})
	...
	data := &TrackList{
		RefSeqs: "http://localhost:5000/link/yeast/refSeqs.json",
		Names: NameStruct{
			Type: "REST",
			URL: "http://localhost:5000/link/names",
		},
		Tracks: tracks,
	}
...
func MainHandler(w http.ResponseWriter, r *http.Request) {
	...
	data := struct {
		...
		FakeDirURL: "http://localhost:5000/link",
		Items: []string{
			"yeast",
		},
	}
